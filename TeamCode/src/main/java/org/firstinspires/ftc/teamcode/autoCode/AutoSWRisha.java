package org.firstinspires.ftc.teamcode.autoCode; //have to change based on package
...
//@Config
@Autonomous(name = "AutoSWRisha")
public class AutoSWRisha extends LinearOpMode {
...
//                        liftPivot.liftPivotDown(),
                        ...
                        intake.intakeArtifact()//lift.liftUp() // to lvl1 ascent
