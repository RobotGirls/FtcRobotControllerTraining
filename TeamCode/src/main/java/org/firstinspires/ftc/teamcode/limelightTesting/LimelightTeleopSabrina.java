...
public class LimelightTeleopSabrina extends LinearOpMode {
...
// can add @Disabled if you dont want this to show up in config
    @Override
    public void runOpMode() {

        // Define and Initialize Motors
        //How motors should appear in your config, if names arent exactly the same it will show an error
        ...
        //Brake will stop the motors from moving even after they have been turned off
        ...
        while (opModeIsActive()) {
            ...
            //usually you shouldnt default to the stick values
