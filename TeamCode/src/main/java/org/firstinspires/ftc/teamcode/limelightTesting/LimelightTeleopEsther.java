...
@TeleOp(name = "Limelight Teleop EL")
public class LimelightTeleopEsther extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (result.isValid()) {
                ...
                if (Math.abs(error) > ALIGN_THRESHOLD) {
                    ...
                    telemetry.addData("Turret Mode", "Auto Aiming");
                    telemetry.addData("Aim Error", "%.2f", error);
                    telemetry.addData("Turret Power", "%.3f", power);
                    telemetry.addData("PID Integral", "%.3f", integralSum);
                    telemetry.addData("PID Derivative", "%.3f", derivative);
                } else {
                    turret.setPower(0);  // aligned
                    telemetry.addData("Turret Mode", "Not Aiming");
                ...
                telemetry.addData(">","GO AIM MANUALLY LAZY BUM");
            }
