...
//This code dosent use derivative or integral because proportional is enough for this specific code
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (result.isValid()) {
                ...
                //all of this is displayed on the driver station with the values from the code below
                ...
                //code for value display when limelight detects april tag
